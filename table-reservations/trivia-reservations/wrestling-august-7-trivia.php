...
<body>
	...
	$subject = "August 7 - Wrestling Trivia";
	$mailheader = "From: Trivia Registration \r\n";
	mail($recipient, $subject, $formcontent, $mailheader) or die("Error!");
	echo "<div class='form-text'>Thank you for your trivia reservation.  We will contact you shortly. And that's the bottom line, cause Joe's said so.</div>";
