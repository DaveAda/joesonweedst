...
<body>
	...
	$subject = "August 28 - The Office Trivia";
	$mailheader = "From: Trivia Registration \r\n";
	mail($recipient, $subject, $formcontent, $mailheader) or die("Error!");
	echo "<div class='form-text'>Thank you for your trivia reservation.  We will contact you shortly.  You have got to make sure that YouTube comes down to tape this!</div>";
